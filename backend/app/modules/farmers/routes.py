...
from app.modules.farmers.service import get_my_dashboard, get_my_profile, upsert_my_profile
...
@router.get("/me/dashboard", response_model=FarmerDashboardRead)
async def read_my_farmer_dashboard(
    current_user: User = Depends(get_current_user),
    session: AsyncSession = Depends(get_session),
) -> FarmerDashboardRead:
    return await get_my_dashboard(session, current_user)
